...
\subsubsection{Interaction with Columbia Gear}
...
\subsubsection{Product Information Overlay}
...
\hangindent=0.5cm \textbf{HTC Vive Controller Models}\\
The hands assets can easily be downloaded from the Unity Asset store, where there are both free and paid options.
...
\hangindent=0.5cm \textbf{Controller Interaction With Rod}\\
...
\hangindent=0.5cm \textbf{Fishing Rod and Line Physics}\\
