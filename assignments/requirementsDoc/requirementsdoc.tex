...
\begin{itemize}
  ...
  product information (visual).
    ...
    \end{itemize}
  \item Immersive noises from outdoor VR experience. This includes audio from the optional user guidance.
    \begin{itemize}
  ...
  \item Ability for other users not using headset to see user's current view.
    ...
    \end{itemize}
  \item Controller available to be held by user.
    \begin{itemize}
...
\begin{itemize}
  \item Must maintain 60fps throughout experience.\cite{hall_2016}
