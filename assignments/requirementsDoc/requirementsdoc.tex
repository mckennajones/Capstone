...
Security should not be an issue in this software system as this project is only concerned with displaying an authentic outdoor environment.
...
The software system should be compatible with all HTC Vive systems. There should be no issue of having the envirionment created in Unity to run on any HTC Vive.
